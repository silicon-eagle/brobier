...
from backend.schemas.beer import BeerEntryCreate, BeerEntryOut, BeerEntryUpdate
from backend.schemas.user_rating import UserRatingCreate, UserRatingOut, UserRatingUpdate
