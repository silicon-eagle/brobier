...
class TestSender:
    def test_build_login_code_email_includes_text_and_html_parts(self) -> None:
    ...
    def test_build_login_code_email_escapes_html_in_code(self) -> None:
        message = build_login_code_email(
            to='friend@example.com',
            code='<ABC123>',
            smtp_from='noreply@brobier.local',
    ...
    def test_send_login_code_email_sends_email(self, login_code: str, mailpit: str) -> None:
